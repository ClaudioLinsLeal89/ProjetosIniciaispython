...
tab1_qtde_produto = tab1_qtde_produto.groupby('Produto vendido').agg({'Quantidade': 'sum', 'Valor Pedido': 'sum'}).reset_index()
...
# Adicione a coluna 'Data' ao DataFrame tab5_vendas_mensais, se não estiver presente
if 'Data' not in tab5_vendas_mensais.columns:
    tab5_vendas_mensais['Data'] = df['Data']
